...
function bdc_page_template_body_classes( $classes ) {
	...
	$template_classes = array(
		...
		'page-explore.php'                  => array( 'explore-page' ),
		'page-for-parents.php'              => array( 'for-parents-page' ),
		...
		'page-community-adventures.php'     => array( 'community-adventures-page', 'program-detail-page' ),
	...
	if ( $page instanceof WP_Post ) {
		$page_slug_classes = array(
			...
			'community-adventures'        => array( 'community-adventures-page', 'program-detail-page' ),
